...
![创建仓库](https://io.nuoyis.net/typecho/uploads/202301180020/1.png "创建仓库")
![创建仓库](https://io.nuoyis.net/typecho/uploads/202301180020/2.png "创建仓库")
然后点击Create repository开始创建,你就得到了如下的页面中的自述和通行证(声明)
![仓库内容](https://io.nuoyis.net/typecho/uploads/202301180020/3.png "仓库内容")
...
![自定义域名](https://io.nuoyis.net/typecho/uploads/202301180020/4.png "自定义域名")
到此搭建就完成了。
穿插自家内容:
